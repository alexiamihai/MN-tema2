...
function [train_mat, train_val] = prepare_data (name, no_train_images)
  ...
  % am incarcat datele din tabelul primit ca argument
  d = load (name);
  % am salvat in matricea train_mat primele no_train_images linii din
  % tabelul de imagini de antrenament
  train_mat = d.trainX(1 : no_train_images, :);
  % am salvat in vectorul train_val primele no_train_images valori ale
